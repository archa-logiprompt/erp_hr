            ...
            <div class="col-xxl-9 box-col-12">
              <div class="row"> 
                ...
                <div class="col-xl-12">
                  <div class="card"> 
                    <div class="card-header card-no-border total-revenue"> 
                      <h4>Important Project List</h4><a class="d-none d-sm-block" href="product.html">View All</a>
                    </div>
                    <div class="card-body pt-0 row important-project">
                      <div class="col-xl-4 col-md-6 box-col-6">
                        <div class="projectlist-card">
                          <div class="projectlist"> 
                            <div class="project-data"><img class="nft-img img-fluid" src="../assets/images/dashboard-2/category/1.png" alt="nft">
                            ...
                            </div><span class="badge rounded-pill badge-primary bg-light-primary">7 Days Left</span>
                          </div>
                          ...
                          <div class="project-comment">
                            ...
                            <div class="project-comment-icon">
                              <div class="project-link"> 
                                <svg>     
                                  <use href="../assets/svg/icon-sprite.svg#messages-2"></use>
                                </svg><span>18 </span>
                              </div>
                              <div class="project-link"> 
                                <svg> 
                                  <use href="../assets/svg/icon-sprite.svg#paperclip"></use>
                                </svg><span>2  </span>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-xl-4 col-md-6 box-col-6">
                        <div class="projectlist-card">
                          <div class="projectlist">
                            <div class="project-data"><img class="nft-img img-fluid" src="../assets/images/dashboard-2/category/2.png" alt="nft">
                            ...
                            </div><span class="badge rounded-pill badge-primary bg-light-primary">24 Days Left</span>
                          </div>
                      ...
                      <div class="col-xl-4 box-col-none marketing-app-card"> 
                        <div class="projectlist-card"> 
                          <div class="projectlist">
                            <div class="project-data"> <img class="nft-img img-fluid" src="../assets/images/dashboard-2/category/3.png" alt="nft">
                            ...
                            </div><span class="badge rounded-pill badge-primary bg-light-primary">31 Days Left</span>
                          </div>
                ...
                <div class="col-xxl-12">
                  <div class="card recent-order">
                    <div class="card-header card-no-border total-revenue"> 
                      ...
                      <div class="header-top"></div><a href="product.html">View All </a>
                    </div>
                    <div class="card-body pt-0"> 
                            ...
                            <tr>
                              <td>
                                <div class="project-comment  d-flex gap-2">
                                  ...
                                  <div> <a class="f-w-500 f-14 " href="product.html">Pet App Design</a>
                                    <div class="project-comment-icon">
                                      <div class="project-link">
                                        <svg>
                                          <use href="../assets/svg/icon-sprite.svg#messages-2"></use>
                            ...
                            <tr>
                              <td>
                                <div class="project-comment  d-flex gap-2">
                                  ...
                                  <div> <a class="f-w-500 f-14 " href="product.html">Chain Desktop App</a>
                                    <div class="project-comment-icon">
                                      <div class="project-link">
                                        <svg>
                                          <use href="../assets/svg/icon-sprite.svg#messages-2"></use>
                            ...
                            <tr>
                              <td>
                                <div class="project-comment  d-flex gap-2">
                                  ...
                                  <div> <a class="f-w-500 f-14 " href="product.html">Business Web Design</a>
                                    <div class="project-comment-icon">
                                      <div class="project-link">
                                        <svg>
                                          <use href="../assets/svg/icon-sprite.svg#messages-2"></use>
                            ...
                            <tr>
                              <td>
                                <div class="project-comment  d-flex gap-2">
                                  ...
                                  <div> <a class="f-w-500 f-14 " href="product.html">NFT App Design</a>
                                    <div class="project-comment-icon">
                                      <div class="project-link">
                                        <svg>
                                          <use href="../assets/svg/icon-sprite.svg#messages-2"></use>
                            ...
                            <tr>
                              <td>
                                <div class="project-comment  d-flex gap-2">
                                  ...
                                  <div> <a class="f-w-500 f-14 " href="product.html">Digital Avtar Web Design</a>
                                    <div class="project-comment-icon">
                                      <div class="project-link">
                                        <svg>
                                          <use href="../assets/svg/icon-sprite.svg#messages-2"></use>
