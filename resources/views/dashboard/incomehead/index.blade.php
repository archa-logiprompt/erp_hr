                              ...
                              <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"> <a href="{{url('/admin/incomehead/edit',$heads->id)}}"><i
                                                                class="icon-pencil-alt"></i></a></li>
                                                    <li class="delete"><a href="{{url('/admin/incomehead/destroy',$heads->id)}}"  onClick="return confirm('Are you sure?');"><i class="icon-trash"></i></a>
                                                    </li>
