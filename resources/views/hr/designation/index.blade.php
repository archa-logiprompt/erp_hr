                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Designation Table</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive custom-scrollbar">
                              <div class="common-flex justify-content-end mb-5">
                                ...
                                <a class="btn btn-primary btn-sm" type="button"  href="{{route('admin.designation.create')}}">Add</a>
                              </div>
                              <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"> <a href="{{url('/admin/designation/edit',$des->id)}}"><i
                                                                class="icon-pencil-alt"></i></a></li>
                                                    <li class="delete"><a href="{{url('/admin/designation/destroy',$des->id)}}"  onClick="return confirm('Are you sure?');"><i class="icon-trash"></i></a>
                                                    </li>
